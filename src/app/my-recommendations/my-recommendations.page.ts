  ...
  recomends: RecomendModel[];
    ...
    openForm(){
      ...
      if(resultData.role==='confirm'){
          ...
          this.recomendService.addRecomendation('',resultData.data.recomendData.laptop_size,
            resultData.data.recomendData.brand,resultData.data.recomendData.laptop,
...
openEdit(rec: RecomendModel){
  console.log('iz myrec: '+rec.laptop);
  ...
  if(resultData.role==='confirm'){
      this.recomendService.editRecomendation(resultData.data.recomendData.id,resultData.data.recomendData.author,resultData.data.recomendData.laptop_size,
        resultData.data.recomendData.brand,resultData.data.recomendData.laptop,
        resultData.data.recomendData.comment).subscribe((res)=>{
          console.log(res);
        });
  ...
  this.alertC.create({
    ...
    buttons:[
      ...
      },
      {
        text: "Yes",
        handler: ()=>{
          this.recomendService.deleteReccomendation(rec).subscribe((res)=>{});
          console.log(rec.id);
